using _34_Nesvetaylov_Project_Eva.NeuroNetwork;
using System;
...
namespace _34_Nesvetaylov_Project_Eva
{
    public partial class FormMain : Form
    {
        ...
        private void Raspoznat(object sender, EventArgs e)
        {
            network.ForwardPass(network, inputpixels);
            Label_Otvet.Text = network.fact.ToList().IndexOf(network.fact.Max()).ToString();
        }
        // Кнопка для обучения
